	...
	<h2 class="titreobj">Passer une Commande</h2>
	      <p> Pour commander Xiaomi Mi Repeater Pro , veuiller remplir le formulaire suivant : </p>


<form   style=" width: 55vw; margin-left : 17vw;" name="form2" method="post" action="index.php?controller=client&action=ordred" >
	<fieldset id="format"> 
		<details open >
			<summary> Création d'un Réseau WiFi </summary>
			<fieldset id="format">
				<details open >
					<summary> Xiaomi </summary>
					<fieldset id="format">
                    <p>
                    Modéle :  Mi Repeater Pro <br>  Prix : 49 TND <br> 
                    Quantité Désiré :<br>
